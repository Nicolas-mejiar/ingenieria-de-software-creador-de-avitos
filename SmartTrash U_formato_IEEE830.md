...
- El sistema debe soportar al menos 10 usuarios concurrentes sin degradación significativa del servicio.
- El tiempo de respuesta de las operaciones principales (inicio de sesión, clasificación de residuos, consulta de puntos) deberá ser:≤ 2 segundos en el 95% de las solicitudes.
- El tiempo de carga inicial de la aplicación web no deberá superar los 2 segundos en condiciones normales de red.
...
- El sistema deberá detectar e invalidar sesiones tras 10 minutos de inactividad.
...
- El sistema deberá garantizar que el 99% de los procesos se completen correctamente.
...
- El sistema deberá ser accesible desde los principales navegadores web: Google Chrome, Mozilla Firefox, Microsoft Edge
...
- El sistema deberá estar desarrollado con tecnologías web estándar (HTML, CSS), facilitando su despliegue en distintos servidores.
